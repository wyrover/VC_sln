#ifndef _ROVERLIB_CTRLS_SPLASHWND_H_
#define _ROVERLIB_CTRLS_SPLASHWND_H_
	...
	namespace ctrls {
		...
		public:
			...
			LRESULT OnPaint(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
			{
				...
				CDC memoryDC;
				if (memoryDC.CreateCompatibleDC(dc.m_hDC))
				{
					CSize size;
					if (m_bmp.GetSize(size))
					{
						HBITMAP hBmpOld = memoryDC.SelectBitmap(m_bmp);
						dc.BitBlt(0, 0, size.cx, size.cy, memoryDC, 0, 0, SRCCOPY);
						memoryDC.SelectBitmap(hBmpOld);
					}
				}
